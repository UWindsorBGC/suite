...
export const command = {
    data: new SlashCommandBuilder()
        .setName('arctic')
        .setDescription('Plays arctic themed music for campaigns, default command plays ambient music.')
        .addStringOption((sub) =>
            sub
                .setName('theme')
    ...
    async execute(inter) {
        ...
        play(inter, await getTheme(inter, theme, 'arctic'), true);

        await inter.reply(`Playing arctic ${theme} in **${inter.member.voice.channel.name}** :mount_fuji:`);
